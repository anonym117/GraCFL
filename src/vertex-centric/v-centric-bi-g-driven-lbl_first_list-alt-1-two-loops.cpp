...
int main(int argc, char **argv)
{
    ...
    std::chrono::time_point<std::chrono::steady_clock> start, finish, startStep1, endStep1, endStep2;
    ...
    do
    {
        ...
        startStep1 = std::chrono::steady_clock::now();
        ...
        endStep1 = std::chrono::steady_clock::now();
        std::chrono::duration<double> stepInterval1 = endStep1 - startStep1;
            ...
            for (uint i = 0; i < num_nodes; i++)
            {
                ...
                for (uint j = START_NEW; j < END_NEW; j++)
                {
                    ...
                    for (uint m = 0; m < g3SizeRight; m++)
                    {
                        ...
                        uint START_OLD_OUT = 0;
                        uint END_OLD_OUT = inEdgeVecs[C][i].OLD_END;
        ...
        endStep2 = std::chrono::steady_clock::now();
        std::chrono::duration<double> stepInterval2 = endStep2 - endStep1;
    ...
    std::cout << "# Total STEP 1 time = " << stepTime1 << endl;
    std::cout << "# Total STEP 2 time = " << stepTime2 << endl;
